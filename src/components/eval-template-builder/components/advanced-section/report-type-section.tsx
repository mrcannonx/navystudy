        ...
        <div className="md:col-span-2">
          ...
          >
            <div className="flex items-center space-x-2 p-2 rounded-md hover:bg-blue-50 transition-colors">
              ...
              <Label htmlFor="regular-radio" className="text-sm font-medium cursor-pointer">Regular</Label>
            </div>
            
            <div className="flex items-center space-x-2 p-2 rounded-md hover:bg-blue-50 transition-colors">
              <RadioGroupItem value="concurrent" id="concurrent-radio" className="text-blue-600" />
              <Label htmlFor="concurrent-radio" className="text-sm font-medium cursor-pointer">Concurrent</Label>
            </div>
          </RadioGroup>
        </div>
      </div>
