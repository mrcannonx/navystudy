...
export const ReportInfoSection: React.FC<ReportInfoSectionProps> = ({
  ...
  return (
    <div>
      ...
      <div className="bg-white p-3 rounded-md border border-blue-50">
        <RadioGroup
          value={radioValue}
          onValueChange={(value) => {
        ...
        >
          <div className="flex items-center space-x-2 p-2 rounded-md hover:bg-blue-50 transition-colors">
            ...
            <Label htmlFor="periodic-radio" className="text-sm font-medium cursor-pointer">Periodic</Label>
          </div>
          
          <div className="flex items-center space-x-2 p-2 rounded-md hover:bg-blue-50 transition-colors">
            <RadioGroupItem value="detachment" id="detachment-radio" className="text-blue-600" />
            <Label htmlFor="detachment-radio" className="text-sm font-medium cursor-pointer">Detachment of Individual</Label>
          </div>
          
          <div className="flex items-center space-x-2 p-2 rounded-md hover:bg-blue-50 transition-colors">
            <RadioGroupItem value="promotionFrocking" id="promotion-frocking-radio" className="text-blue-600" />
            <Label htmlFor="promotion-frocking-radio" className="text-sm font-medium cursor-pointer">Promotion/Frocking</Label>
          </div>
          
          <div className="flex items-center space-x-2 p-2 rounded-md hover:bg-blue-50 transition-colors">
            <RadioGroupItem value="special" id="special-radio" className="text-blue-600" />
            <Label htmlFor="special-radio" className="text-sm font-medium cursor-pointer">Special</Label>
          </div>
        </RadioGroup>
      </div>
    </div>
