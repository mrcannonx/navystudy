          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="space-y-4">
              ...
              <div className="flex space-x-3">
                <Link href="#" className="h-8 w-8 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center text-blue-600 dark:text-blue-400 hover:bg-blue-200 dark:hover:bg-blue-800 transition-colors">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="/quiz" className="text-sm text-muted-foreground hover:text-blue-600 transition-colors">
                    Quizzes
                  </Link>
                </li>
                <li>
                  <Link href="/flashcards" className="text-sm text-muted-foreground hover:text-blue-600 transition-colors">
                    Flashcards
                  </Link>
                </li>
                <li>
                  <Link href="/resources" className="text-sm text-muted-foreground hover:text-blue-600 transition-colors">
                    Resources
                  </Link>
                </li>
                <li>
                  <Link href="/fms-calculator" className="text-sm text-muted-foreground hover:text-blue-600 transition-colors">
                    Calculators
                  </Link>
                </li>
              </ul>
