...
import { Calculator, Info, Scale, Star, ArrowRight, BarChart3 } from "lucide-react"
...
export function FMSHero() {
  const features = [
    {
      icon: Info,
      title: "Whole Person Concept",
      description: "Considers multiple factors to select the most qualified Sailors for advancement"
    },
    {
      icon: Scale,
      title: "Multiple Components",
      description: "Combines exam scores, performance marks, and additional qualification points"
    },
    {
      icon: Calculator,
      title: "Advancement Planning",
      description: "Run scenarios to prepare for upcoming advancement cycles"
    }
  ];
        ...
        <div className="max-w-[76rem] mx-auto">
          ...
          <div className="space-y-6 mb-12">
            ...
            <p className="text-xl text-white/90 max-w-2xl">
              The Final Multiple Score (FMS) is a "Whole Person Concept" that considers multiple elements
              to ensure the most qualified Sailors are advanced.
            </p>
      ...
      <div className="bg-gradient-to-b from-transparent to-blue-900/50 backdrop-blur-sm w-full">
        <div className="max-w-[76rem] mx-auto grid grid-cols-1 md:grid-cols-4 gap-6 px-6 pb-12 sm:px-12 sm:pb-16 md:pb-20 md:px-16 lg:pb-24 lg:px-20">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-semibold text-white mb-1">FMS Calculation</h3>
          ...
          <div className="flex items-start gap-4">
            <div className="p-3 rounded-lg bg-blue-500/30 text-white shadow-sm backdrop-blur-sm">
              <Scale className="h-5 w-5 icon-pulse" />
            </div>
            <div>
              <h3 className="font-semibold text-white mb-1">Paygrade Specific</h3>
              <p className="text-sm text-white/80">
                Different elements for E5/E6 and E7 advancement
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-semibold text-white mb-1">Award Points</h3>
              <p className="text-sm text-white/80">
                Points for your accomplishments as a Sailor
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-white/80">
                Understand how FMS affects your advancement
              </p>
            </div>
          </div>
        </div>
