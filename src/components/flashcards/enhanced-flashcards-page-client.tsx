...
import { EnhancedHeroSection } from "./modules/components/EnhancedHeroSection"
import { EnhancedDeckGrid } from "./modules/components/EnhancedDeckGrid"

// Inner component that uses the context
function EnhancedFlashcardsPageInner() {
            ...
            return (
                <div className="min-h-screen flex items-center justify-center">
                    <div className="text-center space-y-4 max-w-md p-8 bg-white dark:bg-gray-900 rounded-xl shadow-md border border-gray-100 dark:border-gray-800">
                        ...
                        <p className="text-gray-500 dark:text-gray-400">Please sign in to access your flashcard decks</p>
...
export function EnhancedFlashcardsPageClient() {
    return <EnhancedFlashcardsPageInner />;
}